...
Sensor.prototype.setBrickPi = function(brickPi) {
  this._brickPi = brickPi
}

Sensor.prototype.value = function(callback) {
  this._brickPi.once('updatedValues', function(error) {
    callback(error, this._value)
  }.bind(this))
  this._brickPi.updateValues()
}

Sensor.prototype._getType = function() {
