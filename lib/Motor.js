...
/*
  for(var counter = 9; counter > -1; counter--) {
    var bit = (value & 0x1) == 1
    message.set(startLocation + counter, bit)
    value >>= 1
  }*/
  /*
...
Motor.prototype._readEncoderValue = function(message) {
    var value = message.getBits(0, 0, 5)
 ...
 * begin decoding
 */
Motor.prototype._decodeValue = function(wordLength, message) {
  var currentTime = Date.now()
  var tmpEncoderValue = message.getBits(0, 0, 5)
