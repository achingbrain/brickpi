...
Motor.prototype.setArduino = function(arduino) {
...
Motor.prototype.rotate = function(degrees, speed) {
  ...
  if(this._currentEncoderValue === null) {
    return this._arduino.updateValues(this.rotate.bind(this, degrees, speed))
  }
  ...
  var callback = function(error) {
    ...
    if(degrees > 0 && finalValue > this._currentEncoderValue ||
      ...
      return this._arduino.updateValues(callback)
    }

    this.stop()
  }.bind(this)

  this._arduino.updateValues(callback)
}
