...
BrickPi.prototype.addSensor = function(sensor, port) {
  if(!port || (port != BrickPi.PORTS.S5 || isNaN(parseInt(port.chip, 10)) || isNaN(parseInt(port.index, 10)))) {
...
BrickPi.prototype.setUARTAddress = function(address, callback) {
  if(!(this._sensors[BrickPi.PORTS.S1] instanceof BrickPi.Sensors.NXT.Touch)) {
